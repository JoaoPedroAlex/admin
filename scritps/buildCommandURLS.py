...
if len(filenames) > 0:
	...
	filename = filename[:-1]
	commands.append("/opt/IBM/was/WebSphere/AppServer/profiles/DCDmgr/bin/wsadmin.sh -lang jython -f /opt/IBM/was/setup/scripts/resources/CreateURLS.py /opt/IBM/was/setup/input/URLS/%s -javaoption -Dwsadmin.script.libraries=/opt/IBM/was/setup/scripts/info" % (filename))
