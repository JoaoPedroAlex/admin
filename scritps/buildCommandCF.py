...
if len(filenames) > 0:
	...
	filename = filename[:-1]
	commands.append("/opt/IBM/was/WebSphere/AppServer/profiles/DCDmgr/bin/wsadmin.sh -lang jython -f /opt/IBM/was/setup/scripts/resources/CreateConnectionFactory.py -javaoption -Dwsadmin.script.libraries=/opt/IBM/was/setup/scripts/info /opt/IBM/was/setup/input/CF/%s" % (filename))
