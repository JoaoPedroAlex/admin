...
try:
   if typeNameSpaceBinding == 'EjbNameSpaceBinding':
      ...
      nameAttr = ['name', name]
      nameInNameSpaceAttr = ['nameInNameSpace', nameInNameSpace]
      applicationNodeNameAttr = ['applicationNodeName', applicationNodeName]
      applicationServerNameAttr = ['applicationServerName', applicationServerName]
      bindingLocationAttr = ['bindingLocation', bindingLocation]
      ejbJndiNameAttr = ['ejbJndiName', ejbJndiName]
      attrs = [nameAttr, nameInNameSpaceAttr, applicationNodeNameAttr,applicationServerNameAttr, bindingLocationAttr, ejbJndiNameAttr]
      AdminConfig.create('EjbNameSpaceBinding', scopeid, attrs)
      print " OK"
   elif typeNameSpaceBinding == 'StringNameSpaceBinding':
      print "create StringNameSpaceBinding %s" % (name),
      nameAttr = ['name', name]
      nameInNameSpaceAttr = ['nameInNameSpace', nameInNameSpace]
      stringToBindAttr = ['stringToBind', stringToBind]
      attrs = [nameAttr, nameInNameSpaceAttr, stringToBindAttr]
